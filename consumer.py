...
if __name__ == "__main__":
    ...
    # Keywords
    keywordsCounted = wordsRdd.filter(VerifyNotStopWord).filter(VerifyUnicodeLength).countByValueAndWindow(3600,30).transform(lambda rdd: rdd.sortBy(lambda row: row[1],ascending=False))
